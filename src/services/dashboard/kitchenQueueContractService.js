...
function normalizeMeal(slot = {}, slotIndex, fulfillmentType, warnings) {
  ...
  return {
    ...
    premium: {
      ...
      configId: slot.configId ? String(slot.configId) : null,
      ...
      name: slot.name || null,
      nameI18n: slot.nameI18n || null,
      imageUrl: slot.imageUrl || "",
      quantity: Number(slot.quantity || 1),
      coveredQty: Number(slot.coveredQty || 0),
      paidQty: Number(slot.paidQty || 0),
      unitExtraFeeHalala: Number(slot.premiumExtraFeeHalala || slot.unitExtraFeeHalala || 0),
      payableTotalHalala: Number(slot.payableTotalHalala || 0),
      balanceBucketId: slot.balanceBucketId ? String(slot.balanceBucketId) : null,
