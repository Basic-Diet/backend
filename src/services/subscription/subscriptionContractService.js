...
function buildPhase1SubscriptionContract({ payload = {}, resolvedQuote, actorContext = {}, source, now = new Date(), renewalSeed = null, currentBusinessDate = null } = {}) {
  ...
  const addonSubscriptions = (resolvedQuote.addonSubscriptions || []).map((as) => ({
    ...
    quantityPerDay: Number(as.quantityPerDay || as.purchasedDailyQty || 1),
  ...
  const contractSnapshot = {
    ...
    pricing: {
      ...
      basePlanGrossHalala: Number(breakdown.basePlanGrossHalala || breakdown.basePlanPriceHalala || 0),
      basePlanNetHalala: Number(breakdown.basePlanNetHalala || 0),
      ...
      grossTotalHalala: Number(breakdown.grossTotalHalala || 0),
      discountHalala: Number(breakdown.discountHalala || 0),
      totalPriceHalala: Number(breakdown.totalPriceHalala || breakdown.totalHalala || 0),
      subtotalHalala: Number(breakdown.subtotalHalala || 0),
      subtotalBeforeVatHalala: Number(breakdown.subtotalBeforeVatHalala || breakdown.subtotalHalala || 0),
