...
function buildCheckoutRequestHash({ userId, quote }) {
  ...
  const canonicalPayload = {
    ...
    breakdown: {
      ...
      grossTotalHalala: Number(quote.breakdown.grossTotalHalala || 0),
      subtotalHalala: Number(quote.breakdown.subtotalHalala || 0),
      subtotalBeforeVatHalala: Number(quote.breakdown.subtotalBeforeVatHalala || quote.breakdown.subtotalHalala || 0),
  ...
  return {
    ...
    pricingSummary: draft && draft.breakdown
      ? buildMoneySummary({
        ...
        basePlanGrossHalala: draft.breakdown.basePlanGrossHalala,
        basePlanNetHalala: draft.breakdown.basePlanNetHalala,
        subtotalBeforeVatHalala: draft.breakdown.subtotalBeforeVatHalala,
        subtotalHalala: draft.breakdown.subtotalHalala,
        vatPercentage: draft.breakdown.vatPercentage,
        vatHalala: draft.breakdown.vatHalala,
        totalPriceHalala: draft.breakdown.totalPriceHalala || draft.breakdown.totalHalala,
